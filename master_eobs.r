...
master_gridded_plots <- function(){
    ...
    for (i in 1:2){
        ...
        #fits
        plot_maps(file="_fit_2expo_4:100",var="fit_stuff",sub_auswahl=c(NA),value_auswahl=c(6,8,9,14),sig_auswahl=c(17,17,17,17),value_zusatz=c("b1","b2","threshold","distr_size"),sub_zusatz=c(NA),name_zusatz="fit_2expo_4:100",period=period,signi_level=0,farb_mitte=c(0.1,0.3,0.1,0.3,5,15,20,50),farb_palette="lila-gruen",yAusschnitt=c(20,80),xAusschnitt=c(-30,80),asp=1,pointsize=0.44,paper=c(8,5))
