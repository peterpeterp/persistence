...
confidence_interval <- function(seasons=1:4,period="1980-2014",ID_name="ward23",folder=paste("/regional/",ID_name,"/",sep=""),regNumb=23,region_names=c("wNA","cNA","eNA","Eu","wA","cA","eA")){
