...
plot_warm_cold_diff <- function(trendID="91_5",states=2,period="1950-2014",var1="mean",var1_sig=NA,
...
plot_seasonal_anomalie <- function(trendID="91_5",states=2,period="1950-2014",var1="mean",var1_sig=NA,
	...
	region=NA,seasons=c("spring","summer","autumn","winter"),
	grid=FALSE,season_auswahl=c(1,2,3,4),col_row=c(5,2),ausschnitt=c(30,80),cex=cex,subIndex=c("a","b")){
...
plot_multiple_markov(col_row=c(2,2),cex=0.6,name_zusatz="annual_std",season_auswahl=c(5),var1="std",
	titel_zusatz="sd",subIndex=c("a","b"))

plot_multiple_markov(col_row=c(2,2),cex=0.6,name_zusatz="annual_mean",season_auswahl=c(5),var1="mean",
	titel_zusatz="mean",subIndex=c("a","b"))

plot_warm_cold_diff(col_row=c(1,1),cex=0.6,name_zusatz="annual_cowa_mean",season_auswahl=c(5),var1="mean",
	ausschnitt=c(-80,80),farb_palette="lila-gruen",farb_mitte="mean")

plot_seasonal_anomalie(farb_mitte=c(-0.08,0.08),farb_palette="lila-gruen",name_zusatz="seas_anom",
