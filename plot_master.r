...
plot_maps <- function(trendID="91_5",dataset="_TMean",additional_style="",period="1950-2014",file="_others",var="other_stuff",
	...
	vars=c("dur_ana_full")
	print(paste("../data/",trendID,"/",dataset,additional_style,"/duration/",period,"/",trendID,"_",dataset,"_",period,file,".nc",sep=""))
	nc=open.nc(paste("../data/",trendID,"/",dataset,additional_style,"/duration/",period,"/",trendID,"_",dataset,"_",period,file,".nc",sep=""))
